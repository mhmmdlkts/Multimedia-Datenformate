...
plt.imshow(recreate_image(kmeans64.cluster_centers_, labels64, w, h), cmap="gray")

plt.subplot(133)
plt.axis('off')
plt.title('Compressed image (32 colors, K-Means)')

IM1 = recreate_image(kmeans32.cluster_centers_, labels32, w, h)

plt.imshow(IM1, cmap="gray")



cv2.imwrite("path.jpg",IM1)
